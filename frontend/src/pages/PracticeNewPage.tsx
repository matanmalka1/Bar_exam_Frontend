...
const PracticeNewPage = () => {
    ...
    return (
      <div className="mx-auto w-full max-w-[720px] p-4 pb-28 space-y-4">
        <header className="flex items-center justify-between">
          ...
          <h1 className="text-xl font-bold text-gray-900">בחינת מועד</h1>
          <span className="w-16" />
        </header>
        ...
        <section className="space-y-2">
          <p className="text-sm text-gray-600">בחר מועד</p>
          {groups.length === 0 ? (
            <Card>
              <p className="text-sm text-gray-600">אין מועדים זמינים</p>
            </Card>
          ) : (
  ...
  return (
    <div className="mx-auto w-full max-w-[720px] p-4 pb-28 space-y-4">
      ...
      <p className="text-center text-xs text-gray-500">שלב {step} מתוך 3</p>
      ...
      <section className="space-y-2">
        <p className="text-sm font-medium text-gray-700">בחר חלק</p>
      ...
      {part !== null && (
        <section className="space-y-2">
          <p className="text-sm font-medium text-gray-700">בחר מועד</p>
          <div className="flex flex-wrap gap-2">
            <Chip
              selected={allDates}
              onClick={() => {
      ...
      {part !== null && (examDate !== null || allDates) && (
        <section className="space-y-2">
          <p className="text-sm font-medium text-gray-700">מספר שאלות</p>
          <div className="flex flex-wrap gap-2">
